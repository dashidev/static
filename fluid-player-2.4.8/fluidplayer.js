...
var fluidPlayerClass = {
    ...
    playPauseToggle: function (videoPlayerTag) {
        ...
        console.log('preRolls.length:'+preRolls.length);
    ...
    setDefaultLayout: function () {
        ...
        */
        ...
        globalTimer.push(initiateVolumebarTimerId);

        console.log('initiateVolumebarTimerId:'+ initiateVolumebarTimerId)
